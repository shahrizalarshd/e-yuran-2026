<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto space-y-6">
        ...
        <div class="flex gap-3">
            ...
            <a href="{{ route('admin.bills.print', $bill) }}" target="_blank" class="flex-1 py-3 bg-blue-500 text-white font-medium rounded-xl hover:bg-blue-600 transition text-center min-h-touch flex items-center justify-center gap-2">
