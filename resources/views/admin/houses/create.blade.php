            ...
            <form action="{{ route('admin.houses.store') }}" method="POST" class="p-4 lg:p-6 space-y-6">
                ...
                <div class="grid gap-6 lg:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input type="text" name="street_name" id="street_name" value="{{ old('street_name') }}" required class="w-full rounded-lg border-gray-300 focus:border-primary-500 focus:ring-primary-500" placeholder="Jalan Tropika 1">
                        @error('street_name')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
